...
class Ccrudpks_donettd extends CI_Controller {
     ...
     <table id="example1" class="table table-bordered table-striped">
            <thead>
              <tr>
                  ...
                  <th width="15%">Pimpinan Corporate</th>
                  <th width="13%">PIC Corporate</th>
                  <th width="15%">Pimpinan Telkomsel</th>
                  <th width="12%">PIC Telkomsel</th>
        ...
        $this->load->model('mcrudpks');
            $query1 = $this->mcrudpks->selectpks_donettd();
        $i = 1;
  ...
  public function showeditpks(){
    ...
    public function editpks(){
        $this->load->model('mcrudpks');
        $query = $this->mcrudpks->updatepks_ttd2();
    }
